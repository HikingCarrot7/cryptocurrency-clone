...
A `POST` request is used to register a user.
...
A `POST` request is used to login a user.
...
[[resources-coins]]
== Crypto coins service

[[resources-create-coin]]
=== Create crypto coin

A `POST` request is used to create a crypto coin.

==== Request structure

include::{snippets}/coins/http-request.adoc[]

==== Example response

include::{snippets}/coins/http-response.adoc[]

==== CURL request

include::{snippets}/coins/curl-request.adoc[]
